...
Сервіс поширюється за [EUPL-1.2](LICENSE). Сторонні компоненти зберігають власні ліцензії.
Див. [перелік залежностей](licenses.md), [повідомлення й доступ до коду](THIRD_PARTY_NOTICES.md)
та [результати аудиту й відкриті умови випуску](LICENSE_COMPLIANCE.md).

Зміни від 2026-09-15: додано ліцензійні повідомлення, інвентаризацію та включення ліцензій до Docker-образу.
